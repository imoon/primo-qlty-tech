// Navigation 2 - Updated October 5, 2023
function noop() { }
const identity = x => x;
...
function create_each_block_3(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "nav-item svelte-1pmanyg");
...
function create_each_block_2(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "button svelte-1pmanyg");
			attr(a, "href", a_href_value = /*link*/ ctx[11].url);
		},
		m(target, anchor) {
			insert_hydration(target, a, anchor);
		...
		p(ctx, dirty) {
			if (dirty & /*cta*/ 1 && t_value !== (t_value = /*link*/ ctx[11].label + "")) set_data(t, t_value);

			if (dirty & /*cta*/ 1 && a_href_value !== (a_href_value = /*link*/ ctx[11].url)) {
				attr(a, "href", a_href_value);
			}
		},
		d(detaching) {
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(hr, "class", "svelte-1pmanyg");
			attr(button, "id", "close");
			attr(button, "aria-label", "Close Navigation");
			attr(button, "class", "svelte-1pmanyg");
			attr(nav, "id", "mobile-nav");
			attr(nav, "class", "svelte-1pmanyg");
		},
		m(target, anchor) {
...
// (194:8) {#if logo.image.url}
function create_if_block_2(ctx) {
	let a;
	let img;
	let img_src_value;
	let img_alt_value;
	let style___size = `${/*logo*/ ctx[1].size * 0.75}rem`;
	...
	return {
		...
		h() {
			...
			attr(img, "alt", img_alt_value = /*logo*/ ctx[1].image.alt);
			attr(a, "href", "/");
			attr(a, "class", "logo svelte-1pmanyg");
		...
		p(ctx, dirty) {
			...
			if (dirty & /*logo*/ 2 && style___size !== (style___size = `${/*logo*/ ctx[1].size * 0.75}rem`)) {
				set_style(a, "--size", style___size);
			}
		},
		d(detaching) {
...
function create_if_block(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			var span_nodes = children(span);
			t = claim_text(span_nodes, /*subheading*/ ctx[5]);
			span_nodes.forEach(detach);
			this.h();
		},
		h() {
			attr(span, "class", "subheading svelte-1pmanyg");
		},
		m(target, anchor) {
			insert_hydration(target, span, anchor);
			append_hydration(span, t);
...
function create_fragment(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*logo*/ ctx[1].image.url) return create_if_block_3;
		return create_else_block_1;
	}

	let current_block_type = select_block_type(ctx);
	let if_block0 = current_block_type(ctx);
	let each_value_3 = /*site_nav*/ ctx[3];
	let each_blocks_1 = [];
	...
	let if_block1 = /*mobileNavOpen*/ ctx[6] && create_if_block_1(ctx);
	let if_block2 = /*subheading*/ ctx[5] && create_if_block(ctx);
	...
	return {
		...
		l(nodes) {
			...
			t5 = claim_text(h1_nodes, /*heading*/ ctx[2]);
		...
		h() {
			...
			attr(button, "class", "svelte-1pmanyg");
			attr(nav, "class", "svelte-1pmanyg");
			attr(div0, "class", "desktop-nav svelte-1pmanyg");
			attr(div1, "class", "section-container svelte-1pmanyg");
			attr(h1, "class", "heading svelte-1pmanyg");
			attr(div2, "class", "heading-group svelte-1pmanyg");
			...
			attr(header, "class", "svelte-1pmanyg");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*heading*/ 4) set_data(t5, /*heading*/ ctx[2]);

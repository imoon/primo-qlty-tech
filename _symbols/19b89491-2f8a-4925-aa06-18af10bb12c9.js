// Site Footer - Updated October 4, 2023
function noop() { }
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t9 = claim_text(span2_nodes, "Qlty Tech Inc.");
		...
		h() {
			...
			attr(span0, "class", "svelte-1mwa1v0");
			attr(a, "class", "email svelte-1mwa1v0");
			attr(a, "href", a_href_value = "mailto:" + /*email*/ ctx[0]);
			attr(div0, "class", "primary svelte-1mwa1v0");
			attr(span1, "class", "copyright svelte-1mwa1v0");
			attr(span2, "class", "primo svelte-1mwa1v0");
			attr(ul, "class", "svelte-1mwa1v0");
			attr(div1, "class", "secondary svelte-1mwa1v0");
			attr(div2, "class", "section-container svelte-1mwa1v0");
		},
		m(target, anchor) {
